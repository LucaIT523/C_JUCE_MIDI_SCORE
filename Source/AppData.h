...
public:
    ...
    static const juce::uint32 componentMusicScoreBackgroundColour = 0xffffffff;//0xff4a505c;//0xFF4e5563;
    ...
    static const juce::uint32 defaultLineColour = 0xffff0000;//0xFFA9BFCF;
    ...
    static const juce::uint32 notePlayingColour = 0xffff0000;//0xfff0f682;//0xFFCED78D;
